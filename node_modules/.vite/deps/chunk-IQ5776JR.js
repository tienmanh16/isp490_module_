    ...
    (function(root, factory) {
      ...
      var blocks$$module$build$src$blocks$procedures = {}, PROCEDURE_DEF_COMMON$$module$build$src$blocks$procedures = { setStatements_: function(a) {
        ...
        if (c && c.bubbleIsVisible()) {
          ...
          for (let d = 0, e; e = c[d]; d++)
            e.type === "procedures_mutatorarg" && $.Names$$module$build$src$core$names.equals(a, e.getFieldValue("NAME")) && e.setFieldValue(b, "NAME");
        }
      ...
      var DISABLED_PROCEDURE_DEFINITION_DISABLED_REASON$$module$build$src$blocks$procedures = "DISABLED_PROCEDURE_DEFINITION", PROCEDURE_CALL_COMMON$$module$build$src$blocks$procedures = { getProcedureCall: function() {
        ...
        for (let d = 0, e; e = a.childNodes[d]; d++)
          e.nodeName.toLowerCase() === "arg" && (b.push(e.getAttribute("name")), c.push(e.getAttribute("paramId")));
        ...
        if (this.workspace && !this.workspace.isFlyout && a.recordUndo)
          if (a.type === $.BLOCK_CREATE$$module$build$src$core$events$events && a.ids.includes(this.id)) {
            ...
            if (c)
              c.isEnabled() || (this.setDisabledReason(true, DISABLED_PROCEDURE_DEFINITION_DISABLED_REASON$$module$build$src$blocks$procedures), this.setWarningText($.Msg$$module$build$src$core$msg.PROCEDURES_CALL_DISABLED_DEF_WARNING.replace(
                "%1",
                b
              )));
            else {
            ...
            a.type === $.BLOCK_DELETE$$module$build$src$core$events$events ? (b = this.getProcedureCall(), $.getDefinition$$module$build$src$core$procedures(
              b,
              this.workspace
      ...
      var loopTypes$$module$build$src$blocks$loops = /* @__PURE__ */ new Set(["controls_repeat", "controls_repeat_ext", "controls_forEach", "controls_for", "controls_whileUntil"]), CONTROL_FLOW_NOT_IN_LOOP_DISABLED_REASON$$module$build$src$blocks$loops = "CONTROL_FLOW_NOT_IN_LOOP", CONTROL_FLOW_IN_LOOP_CHECK_MIXIN$$module$build$src$blocks$loops = { getSurroundLoop: function() {
        ...
        if (b.isDragging && !b.isDragging() && (a.type === $.BLOCK_MOVE$$module$build$src$core$events$events || a.type === $.BLOCK_CREATE$$module$build$src$core$events$events) && (a = !!this.getSurroundLoop(), this.setWarningText(a ? null : $.Msg$$module$build$src$core$msg.CONTROLS_FLOW_STATEMENTS_WARNING), !this.isInFlyout))
          try {
      ...
      var LISTS_GETINDEX$$module$build$src$blocks$lists = { init: function() {
        ...
        this.setTooltip(() => {
          ...
          if (c === "FROM_START" || c === "FROM_END")
            d += "  " + (c === "FROM_START" ? $.Msg$$module$build$src$core$msg.LISTS_INDEX_FROM_START_TOOLTIP : $.Msg$$module$build$src$core$msg.LISTS_INDEX_FROM_END_TOOLTIP).replace(
              "%1",
...
//# sourceMappingURL=chunk-IQ5776JR.js.map
